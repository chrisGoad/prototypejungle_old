...
var labelC = item.set('labelC',item.labelsP.instantiate());
item.labelC.show();
item.labelSep = 20;
...
item.set('circles',pj.Marks.mk(item.circleP));
...
debugger;
  ...
  if (!numD) {
    ...
    this.labelC.moveto(this.minX,this.height+this.labelSep);
  ...
  this.circles.setData(this.data);
