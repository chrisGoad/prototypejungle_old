...
function mkPath(which,version,mini,protochart) {
  return (protochart?'../protochart/':'')+"www/js/"+which+"-"+version+(mini?".min":"")+".js";
}
...
function mkModule(which,version,contents,cb) {
  ...
  var chartPath = mkPath(which,version,0,1);
