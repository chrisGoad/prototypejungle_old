  /**
    an emergency small web server whose  only job is to redirect to imagediver.org,mapbureau.com
     */
...
var port = 80
    ...
    http.createServer(function(request, response) {
        ...
        if (fpage && fRedirect) {
          if (imdiver) {
            var rdir = 'http://imagediver.org:8080';
          } else {
            rdir = 'http://mapbureau.com:8080';
          }
          rdir = rdir + pn;
          console.log("rdir ",pn);
