...
om.install(["http://s3.prototypejungle.org/pj/repo0/pix/TwoArcs"],function () {
  var pix = __pj__.setIfMissing("pix");
  var om = __pj__.om;
  var geom = __pj__.geom;
  var draw = __pj__.draw;
  var top = pix.set("FourArcs",geom.Shape.mk());
  ...
  top.arc2.radius = 100;
  top.arc3.radius = 125;
  top.arc0.draggable = 1;
  top.arc1.draggable = 1;
  top.arc2.draggable = 1;
  top.arc3.draggable = 1;
  var pair0 = top.set("pair0",pix.TwoArcs.instantiate());
  var pair1 = top.set("pair1",pix.TwoArcs.instantiate());
