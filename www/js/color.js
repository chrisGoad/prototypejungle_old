...
(function (__pj__) {
  ...
  var draw = __pj__.set("color",__pj__.om.DNode.mk());
  color.__externalReferences__ = [];
  color.__coreModule__ = 1;


 

  
  color.installType("Rgb");

  // formats supported "rgb(r,g,b) #xxxxxx three nums
  // g is treated as noAlpha if r is a string
  color.Rgb.mk = function (r,g,b,a) {
